...
def configure_logging():
    ...
    Logging Configuration:
        ...
        - **Application Logger**: Configures a logger named `wmata-bus-position` with the same console handler,
    ...
    Notes:
        ...
        - The `wmata-bus-position` logger can be used for application-specific logging needs.
    ...
    logging_config = {
        ...
        "loggers": {
            "wmata-bus-position": {  # Application-specific logger
                "level": "INFO",
                "handlers": ["console"],
                "propagate": False,
            }
...
logger = logging.getLogger("wmata-bus-position")
