# Variables
SHELL := /bin/bash
IMAGE_NAME := wmata-bus-position-python
COMPOSE_FILE := compose.yml
PROJECT := wmata-bus-position
VENV := venv
...
create-k8s-deployment: ## Create k8s deployment
	...
	#kubectl apply -f wmata_bus_position_deployment.yaml
...
delete-k8s-deployment: ## Delete k8s deployment
	...
	#kubectl delete -f wmata_bus_position_deployment.yaml
